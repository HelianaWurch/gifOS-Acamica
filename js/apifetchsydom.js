...
const searchCrossBtnContainer = document.querySelector(
  '#button-cross-container'
); // Detecta el contenedor del boton para borrar busqueda.
...
const searchBtnNavContainer = document.querySelector(
  '#button-search-nav-container'
); // Detecta el contenedor del boton de busqueda del nav.
const searchCrossBtnNavContainer = document.querySelector(
  '#button-cross-nav-container'
); // Detecta el contenedor del boton para borrar busqueda.
